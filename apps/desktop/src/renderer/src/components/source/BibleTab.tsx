  ...
  return (
    <div className="flex flex-col h-full min-h-0">
      ...
      <div className="flex flex-col gap-2 shrink-0">
        ...
        {/* Chapter grid — capped height to prevent squeezing the verse area */}
        {state.currentBook && (
      ...
      {/* Fixed bottom — status messages + action buttons always visible */}
      <div className="shrink-0">
        {state.err && <p className="text-xs text-destructive pb-1">{state.err}</p>}
        {state.info && <p className="text-xs text-muted-foreground pb-1">{state.info}</p>}
        ...
        {state.verses.length > 0 && (
          <div className="space-y-1 bg-card pt-1 border-t">
